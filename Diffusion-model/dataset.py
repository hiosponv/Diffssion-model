...
# 数据集Pytorch Dataset
# train_dataset=torchvision.datasets.CIFAR10(root=".",train=True,download=True, transform=pil_to_tensor) # 手写数字图像pillow(PIL),对应的数字
def build_dataset(rank, train):
    # rank0 下载一次
    if rank == 0:
        torchvision.datasets.CIFAR10(root=".", train=True, download=True, transform=pil_to_tensor)
